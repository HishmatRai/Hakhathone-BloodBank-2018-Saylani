        ...
        <Router>
          <div>
            <MDBNavbar dark expand="md" fixed="top">
              <MDBContainer>
                <MDBNavbarBrand>
                  <img src="https://p7.hiclipart.com/preview/841/286/562/blood-donation-dr-shirgaonkar-blood-bank-blood-donation.jpg" width="50px" />

                  <strong className="white-text" >Thar Blood Bank</strong>
                </MDBNavbarBrand>
                <MDBNavbarToggler
                  onClick={this.toggleCollapse("navbarCollapse")}
                />
                    ...
                    <MDBCard id="classic-card">
                      <MDBCardBody className="white-text">
                        ...
                        <div className="text-center mt-4 black-text">
                          ...
                          <Button onClick={() => this.login()} style={{ backgroundColor: "#3AAFA9", color: "white" }} >Log in</Button>
                          <span class="vl-innertext"> OR </span>
                          <Link to='/Sign-Up'>

                            <Button style={{ backgroundColor: "#3AAFA9", color: "white" }}>Sign up</Button>
                          </Link>
                          <hr className="hr-light" />
